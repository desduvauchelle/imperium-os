...
// Validate ../../app/api/invoke/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/invoke">> = Specific
  const handler = {} as typeof import("../../app/api/invoke/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
